package com.sevensegment.jobis.review.jpa.entity;
...
public class QReviewEntity extends EntityPathBase<ReviewEntity> {
    ...
    private static final long serialVersionUID = 716075743L;
    ...
    public final com.sevensegment.jobis.user.jpa.entity.QUserEntity user;
    ...
    public QReviewEntity(Class<? extends ReviewEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.sevensegment.jobis.user.jpa.entity.QUserEntity(forProperty("user")) : null;
    }
