package com.sevensegment.jobis.admin.controller;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.sevensegment.jobis.admin.model.service.AdminService;
...
public class AdminController {
    ...
    public Page<Map<String, Object>> getSalesHistory(@RequestParam(required = false) String filter,@RequestParam(required = false) String search,@RequestParam(required = false) String cancelYN,Pageable pageable) {
